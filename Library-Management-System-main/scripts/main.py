...
def start():  # sourcery skip: low-code-quality, use-named-expression
    wrong_option = 5
    failed_auth = 5

    while True:
        _extracted_from_start_42(
            '\t\t\t\t|                  Home                  |',
            '\t\t\t\t------------------------------------------',
            '\t\t\t\t|          1. Student Login              |',
        )
        ...
        match choice:
            case '1':
                ...
                if len(stud_id) == 0 or len(stud_pass) == 0:
                    ...
                    print(
                        f'\t\t\t\t\t|      Remaining attempts : {failed_auth}      |'
                    )
                    print('\t\t\t\t------------------------------------------')
                    failed_auth -= 1
                    continue
            ...
            case '2':
                ...
                while True:
                    ...
                    if (
                        len(stud_name) < 1
                        or len(stud_pass_1) < 1
                        or len(stud_pass_2) < 1
                        or len(stud_batch) < 1
                    ):
                        print(
                            '\t\t\t\t\tPlease enter a valid student details.'
                        )
            ...
            case _:
                ...
                print(
                    f'\t\t\t\t|       Remaining attempts : {wrong_option}           |'
                )
                print('\t\t\t\t------------------------------------------')
                wrong_option -= 1
...
def _extracted_from_start_42(arg0, arg1, arg2):
    print('\t\t\t\t------------------------------------------')
    print(arg0)
    print(arg1)
    print(arg2)
...
def check_and_create_file(path, file_name):
    ...
    #sorcery skip: use-named-expression
